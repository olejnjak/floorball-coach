...
target.frontMostApp().mainWindow().collectionViews()[0].cells()["[Favorite exercises]"].buttons()[0].tap();

var count = target.frontMostApp().mainWindow().tableViews()[0].cells().length;

target.frontMostApp().toolbar().buttons()["[Back]"].tap();

target.frontMostApp().mainWindow().collectionViews()[0].cells()["[Exercise list]"].buttons()[0].tap();
